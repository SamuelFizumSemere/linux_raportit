...
## virtualbox asennus ja virtuaalikoneen luonti
...
Avoimen lähdekoodin ohjelmistoissa koodi on kaikkien nähtävillä, joten sitä voi käyttää, 
muokata ja kehittää. Se helpottaa ohjelmistojen tekemistä, koska kehittäjät voivat tehdä yhteistyötä ja hyödyntää muiden tekemää työtä.

Avoin lähdekoodi on tärkeä osa nykyistä teknologiaa, koska sitä käytetään monissa sovelluksissa, palveluissa ja digitaalisissa järjestelmissä. Se tekee teknologiasta helpommin saatavilla olevaa ja nopeuttaa sen kehitystä.
